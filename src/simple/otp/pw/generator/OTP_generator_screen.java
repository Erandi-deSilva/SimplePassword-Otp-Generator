 ...
 * @author ASUS
 */
public class OTP_generator_screen extends javax.swing.JFrame {

    /**
     * Creates new form OTP_generator_screen
     */
    public OTP_generator_screen() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Your OTP is :");

        generateBtn.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        generateBtn.setText("Generate OTP");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OTP_generator_screen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OTP_generator_screen().setVisible(true);
            }
        });
    }
